...
def generate_video_from_question(question_text):
    ...
    api_key = os.environ.get('api_key', 'sk-ILMjQUrivWylbavnTBhzRlqwLBMwmK3U58HEGCqKDs7dxOSF')
...
def main():
    # Get Groq API key
    groq_api_key = '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'  # Replace with your actual API key
    ...
    prep = f"You are an English teacher. Ask conversation related questions for improving communication, correct the response for grammer, and evaluate the performance.repeat this until user ask to stop" 
    ...
    # Ask the first question if it hasn't been asked yet
    ...
    # Loop through each question and process responses
    while st.session_state.question_index < 5:  # Assuming three questions for the mock interview
